...
#define GitVersion 0 // 0x@GIT_COMMIT_HASH@
#define GitBranch "@GIT_BRANCH@"

#define VER_MAJOR 0 // @ASSIMP_VERSION_MAJOR@
#define VER_MINOR 0 // @ASSIMP_VERSION_MINOR@
#define VER_PATCH 0 // @ASSIMP_VERSION_PATCH@
#define VER_BUILD 0 // @ASSIMP_PACKAGE_VERSION@
